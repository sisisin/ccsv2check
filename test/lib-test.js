...
const samples = {
  ...
  circle: {
    row:
      'Circle,106291,1,174,28,日,東,に,15,999,Happa,,おーみや,,,,,,3507,357,1,1,,http://happa.moo.jp/,https://twitter.com/oomiya,,,,',
    instance: new Circle({
      colorNumber: '1',
      spacePrefix: 'に',
      spaceNum: '15',
  ...
  unknown: {
    row:
      'UnKnown,106291,1,174,28,日,東,に,15,999,Happa,,おーみや,,,,,,3507,357,1,1,,http://happa.moo.jp/,https://twitter.com/oomiya,,,,',
    instance: new Circle({
      colorNumber: '1',
      spacePrefix: 'に',
      spaceNum: '15',
...
describe('#toRenderString', () => {
  it('should return csv string only header when no `circles` data', () => {
    expect(
      ...
      'color,space_prefix,space_num,space_suffix,circle_name,author_name,url,circle_ms_url\n',
    );
  });
